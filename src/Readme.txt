...
Os dois scripts são executados chamando python3 graph_plots.py e python3 simulate.py

observação: Os dois scripts demoram um tempo significato para terminar , uma vez que as simulaçoes
executadas são bem grandes.
